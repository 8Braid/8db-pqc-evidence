...
records per role passed. Independent review replayed the recorded validators
and rehashed 80 consumed original files against the closed inventory.

A separate optimized test build on this candidate's production code completed
177 active controls and all three injected clock-fault cases. Its local delivery
rehearsal completed 2,176 records, including 128 submitted during draining.
Independent verification checked every ML-DSA-87 receipt against its original
request, the receiver's exact content, source completion and the cold-reopened
stores. The [delivery and release checkpoint](mesh/protected-node-2026-09-16/DELIVERY-CHECKPOINT-1430Z.md)
records the distinct source and executable identities, retry observations and
remaining release gates. A configuration-only repeat reduced the observed
reconnect time from 107.734 to 33.858 seconds, with one send attempt per record
and all 2,176 receipts independently verified.
...
The selected candidate is `326ab0a1333dd7f6f13d4c0fff503f9d5eefaa5e`, tree
